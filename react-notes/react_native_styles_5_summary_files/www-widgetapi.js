...
;var vh=Pe("networkless_throttle_timeout")||100,wh=Pe("networkless_retry_attempts")||1,xh=0;function yh(a,b){b=void 0===b?{}:b;zh().then(function(c){if(c&&!S("networkless_bypass_write")){var d={url:a,options:b,timestamp:T(),status:"NEW",sendCount:0};eh(d).then(function(e){d.id=e;e=ph();e.f&&!S("networkless_always_offline")?Ah(d):qh(e)})["catch"](function(e){Ah(d);
oe(e)})}else ig(a,b)})}
